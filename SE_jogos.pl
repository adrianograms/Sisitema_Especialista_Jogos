main :- nl, write('Sistema Especialista de recomendação de jogos para leigos.\n'), nl, write('O sistema usa diversas perguntas para determinar suas recomendações'),
    nl, write('Cada pergunta terá algumas repostas possiveis, as quais possuirão um numero ao lado'), nl,
...
jogo(120, A, B) :-
    temCoop("nao"),temHistoria("centraç"),tempoJogatina("longa"),tipoGraficos("2d"), tipoJogo("ind"),
...
% Jogo tem ou não historia,e se tem, se ela é central
temHistoria("sim") :-
...
% Jogo é para toda familia ou não
eFamily("sim") :-
    !.
eFamily("nao") :-
    family(2).

% Jogo é ou não portatil
ePortatil("sim") :-
    !.
ePortatil("nao") :-
    portatil(2).

% Jogo é ou não de esportes
eDeEsportes("sim") :-
    esportes(1); esportes(3).
eDeEsportes("nao") :-
    esportes(1); esportes(2).

% Jogo é ou não um simulador
eSimulador("sim") :-
...
% ------------------------------------------------------------------
coop(A) :-
    pergunte(coop, X , "Você pretende/deseja jogar com os amigos (localmente ou/e online) ?\n1-Sim\n2-Nao\n3-Só quero jogos com coop\n"), A = X.
historia(A) :-
    pergunte(historia, X, "Você deseja jogos com uma boa historia e/ou com foco na historia ?\n1-Sim\n2-Nao\n3- Só quero jogos com foco/boa historia\n"), A = X.
tempo(A) :-
    pergunte(tempo, X, "Gostaria de jogos com jogatinas mais longas(sessões maiores, onde você se investe mais no jogo ao qual está jogando) ou curtas (partidas rapidas descompromissadas) ?\n1-Longa\n2-Curta\n3-Os dois\n"), A = X.
graficos(A) :-
...
family(A) :-
    pergunte(family, X, "Você permite jogos com temas pesados, ou apenas jogos para familia ?\n1-Familiar\n2-Tanto faz\n"), A = X.
portatil(A) :-
...
simulador(A) :-
    pergunte(simulador, X, "Você se interessa por simluadores (jogos que simulam alguma atividade/processo do mundo) ?\n1-Sim\n2-Nao\n3-Só quero jogos que são simlutadores\n"), A = X.
leitura(A) :-
